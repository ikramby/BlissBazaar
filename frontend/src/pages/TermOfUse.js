  ...
  return (
    <Container maxWidth="md" sx={{ mt: 4, color: "white" }}>
      ...
      <Typography variant="body1" paragraph>
        Welcome to TechBazaar! By using our website, you agree to comply with
        and be bound by the following terms and conditions of use. If you
      ...
      <Typography variant="body1" paragraph>
        We shall not be liable for any loss or damage arising from the use of,
        or reliance on, the information and materials provided on this website.
      </Typography>
      <Typography variant="h5" gutterBottom>
        Changes to Terms of Use
      </Typography>
      <Typography variant="body1" paragraph>
        TechBazaar may revise these terms of use for its website at any time
