  ...
  return (
     ...
     */} 
      <CardContent >
        ...
        <Typography variant="body2" color="white" style={{maxHeight:'10vh', minHeight:'10vh', minWidth:'250PX'}}>
        {description}
        </Typography>
       ...
       */} 
       ...
       {(userRole ==='Selling') && ( <><Button size="small" style={{ color: 'white', fontSize: '20px' }} onClick={handleEditClick}>
          Edit
        </Button> 
